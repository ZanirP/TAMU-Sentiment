...
if __name__ == "__main__":
	...
	df = pd.read_csv("data/processed-data/tweets.csv")
	...
	save_directory = "data/output_graphs/demo_graphs"
	barplot1 = plt.bar(df1['event'], df1['sentiment_score'])

	
	organize_and_save_plot("Events", "Sentiment Scores", "Scores of Events", "data/output_graphs/demo_graphs", "barplot1.png")
